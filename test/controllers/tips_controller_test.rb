...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { activity_type: @tip.activity_type, description: @tip.description, name: @tip.name, references: @tip.references }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { activity_type: @tip.activity_type, description: @tip.description, name: @tip.name, references: @tip.references }
    assert_redirected_to tip_path(assigns(:tip))
  end
